...
includeClient( "cfc_http_restrictions/client/chatfilter.lua" )
includeClient( "cfc_http_restrictions/client/proxy.lua" )

runOnDir( "cfc_http_restrictions/wraps", AddCSLuaFile )
includeServer( "cfc_http_restrictions/server/config_loader.lua" )
includeServer( "cfc_http_restrictions/server/chatfilter.lua" )
includeServer( "cfc_http_restrictions/server/proxy.lua" )
